...
//     description: "Necxis terms & conditions"
// }
...
export default function TermsConditions() {
    return (
        <Container>
            ...
            <div style={{ fontFamily: 'Arial, sans-serif', lineHeight: '1.6', color: '#333', margin: '0', padding: '20px' }}>
                <h1 style={{ color: '#0056b3', borderBottom: '2px solid #0056b3', paddingBottom: '10px' }}>Terms and Conditions</h1>
                <p>Last updated May 25, 2024</p>

                <div style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>AGREEMENT TO OUR LEGAL TERMS</h2>
                    <p>We are Necxis ("Company," "we," "us," "our"), a company registered in India at Delhi, India.</p>
                    <p>We operate the website <a href="http://necxis.com/" style={{ color: '#0056b3', textDecoration: 'none' }}>necxis.com</a> (the "Site"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").</p>
                    <p>You can contact us by email at <a href="mailto:help@necxis.com" style={{ color: '#0056b3', textDecoration: 'none' }}>help@necxis.com</a> or by mail to Delhi, India, India.</p>
                    <p>These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Necxis, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.</p>
                ...
                <div style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>TABLE OF CONTENTS</h2>
                    <div style={{ marginTop: '20px', paddingLeft: '20px' }}>
                        <a href="#services" style={{ color: '#0056b3', textDecoration: 'none' }}>1. OUR SERVICES</a><br />
                        <a href="#intellectual-property" style={{ color: '#0056b3', textDecoration: 'none' }}>2. INTELLECTUAL PROPERTY RIGHTS</a><br />
                        <a href="#user-representations" style={{ color: '#0056b3', textDecoration: 'none' }}>3. USER REPRESENTATIONS</a><br />
                        <a href="#user-registration" style={{ color: '#0056b3', textDecoration: 'none' }}>4. USER REGISTRATION</a><br />
                        <a href="#purchases-payment" style={{ color: '#0056b3', textDecoration: 'none' }}>5. PURCHASES AND PAYMENT</a><br />
                        <a href="#policy" style={{ color: '#0056b3', textDecoration: 'none' }}>6. POLICY</a><br />
                        <a href="#prohibited-activities" style={{ color: '#0056b3', textDecoration: 'none' }}>7. PROHIBITED ACTIVITIES</a><br />
                        <a href="#user-contributions" style={{ color: '#0056b3', textDecoration: 'none' }}>8. USER GENERATED CONTRIBUTIONS</a><br />
                        <a href="#contribution-license" style={{ color: '#0056b3', textDecoration: 'none' }}>9. CONTRIBUTION LICENSE</a><br />
                        <a href="#services-management" style={{ color: '#0056b3', textDecoration: 'none' }}>10. SERVICES MANAGEMENT</a><br />
                        <a href="#privacy-policy" style={{ color: '#0056b3', textDecoration: 'none' }}>11. PRIVACY POLICY</a><br />
                        <a href="#term-termination" style={{ color: '#0056b3', textDecoration: 'none' }}>12. TERM AND TERMINATION</a><br />
                        <a href="#modifications-interruptions" style={{ color: '#0056b3', textDecoration: 'none' }}>13. MODIFICATIONS AND INTERRUPTIONS</a><br />
                        <a href="#governing-law" style={{ color: '#0056b3', textDecoration: 'none' }}>14. GOVERNING LAW</a><br />
                        <a href="#dispute-resolution" style={{ color: '#0056b3', textDecoration: 'none' }}>15. DISPUTE RESOLUTION</a><br />
                        <a href="#corrections" style={{ color: '#0056b3', textDecoration: 'none' }}>16. CORRECTIONS</a><br />
                        <a href="#disclaimer" style={{ color: '#0056b3', textDecoration: 'none' }}>17. DISCLAIMER</a><br />
                        <a href="#limitations-liability" style={{ color: '#0056b3', textDecoration: 'none' }}>18. LIMITATIONS OF LIABILITY</a><br />
                        <a href="#indemnification" style={{ color: '#0056b3', textDecoration: 'none' }}>19. INDEMNIFICATION</a><br />
                        <a href="#user-data" style={{ color: '#0056b3', textDecoration: 'none' }}>20. USER DATA</a><br />
                        <a href="#electronic-communications" style={{ color: '#0056b3', textDecoration: 'none' }}>21. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a><br />
                        <a href="#miscellaneous" style={{ color: '#0056b3', textDecoration: 'none' }}>22. MISCELLANEOUS</a><br />
                        <a href="#contact-us" style={{ color: '#0056b3', textDecoration: 'none' }}>23. CONTACT US</a>
                    </div>
                </div>

                <div id="services" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>1. OUR SERVICES</h2>
                    <p>The information provided when using the Services is not intended for distribution to or use by any person or entity in any jurisdiction or country where such distribution or use would be contrary to law or regulation or which would subject us to any registration requirement within such jurisdiction or country. Accordingly, those persons who choose to access the Services from other locations do so on their own initiative and are solely responsible for compliance with local laws, if and to the extent local laws are applicable.</p>
                </div>

                <div id="intellectual-property" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>2. INTELLECTUAL PROPERTY RIGHTS</h2>
                    <h3 style={{ color: '#0056b3' }}>Our intellectual property</h3>
                    ...
                    <h3 style={{ color: '#0056b3' }}>Your use of our Services</h3>
                    ...
                    <p>If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: help@necxis.com. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.</p>
                    ...
                    <p>You are responsible for what you post or upload: By sending us Submissions and/or posting Contributions through any part of the Services or making Contributions accessible through the Services by linking your account through the Services to any of your social networking accounts, you:
                        ...
                        to the extent permissible by applicable law, waive any and all moral rights to any such Submission and/or Contribution;</p>
                ...
                <div id="user-representations" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>3. USER REPRESENTATIONS</h2>
                ...
                <div id="user-registration" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>4. USER REGISTRATION</h2>
                ...
                <div id="purchases-payment" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>5. PURCHASES AND PAYMENT</h2>
                ...
                <div id="policy" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>6. POLICY</h2>
                    <p>All sales are final and no refund will be issued.</p>
                </div>

                <div id="prohibited-activities" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>7. PROHIBITED ACTIVITIES</h2>
                    ...
                    <p>As a user of the Services, you agree not to:
                        ...
                        Trick, defraud, or mislead us and other users, especially in any attempt to learn sensitive account information such as user passwords.</p>
                    ...
                    <p>Interfere with, disrupt, or create an undue burden on the Services or the networks or services connected to the Services.
                ...
                <div id="user-contributions" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>8. USER GENERATED CONTRIBUTIONS</h2>
                ...
                <div id="contribution-license" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>9. CONTRIBUTION LICENSE</h2>
                ...
                <div id="services-management" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>10. SERVICES MANAGEMENT</h2>
                ...
                <div id="privacy-policy" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>11. PRIVACY POLICY</h2>
                    <p>We care about data privacy and security. Please review our Privacy Policy: necxis.com/public/privacy_policy. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in India. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in India, then through your continued use of the Services, you are transferring your data to India, and you expressly consent to have your data transferred to and processed in India.</p>
                </div>

                <div id="term-termination" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>12. TERM AND TERMINATION</h2>
                    <p>
                ...
                <div id="modifications-interruptions" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>13. MODIFICATIONS AND INTERRUPTIONS</h2>
                ...
                <div id="governing-law" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>14. GOVERNING LAW</h2>
                    <p>These Legal Terms shall be governed by and defined following the laws of India. Necxis and yourself irrevocably consent that the courts of India shall have exclusive jurisdiction to resolve any dispute which may arise in connection with these Legal Terms.</p>
                </div>

                <div id="dispute-resolution" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>15. DISPUTE RESOLUTION</h2>
                ...
                <div id="corrections" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>16. CORRECTIONS</h2>
                    <p>There may be information on the Services that contains typographical errors, inaccuracies, or omissions, including descriptions, pricing, availability, and various other information. We reserve the right to correct any errors, inaccuracies, or omissions and to change or update the information on the Services at any time, without prior notice.</p>
                </div>

                <div id="disclaimer" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>17. DISCLAIMER</h2>
                ...
                <div id="limitations-liability" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>18. LIMITATIONS OF LIABILITY</h2>
                ...
                <div id="indemnification" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>19. INDEMNIFICATION</h2>
                ...
                <div id="user-data" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>20. USER DATA</h2>
                    <p>We will maintain certain data that you transmit to the Services for the purpose of managing the performance of the Services, as well as data relating to your use of the Services. Although we perform regular routine backups of data, you are solely responsible for all data that you transmit or that relates to any activity you have undertaken using the Services. You agree that we shall have no liability to you for any loss or corruption of any such data, and you hereby waive any right of action against us arising from any such loss or corruption of such data.</p>
                </div>

                <div id="electronic-communications" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>21. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
                ...
                <div id="miscellaneous" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>22. MISCELLANEOUS</h2>
                ...
                <div id="contact-us" style={{ marginBottom: '30px' }}>
                    <h2 style={{ color: '#0056b3', marginTop: '30px' }}>23. CONTACT US</h2>
                    <p>In order to resolve a complaint regarding the Services or to receive further information regarding use of the Services, please contact us at: help@necxis.com</p>
                </div>
